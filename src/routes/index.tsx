...
import { Camera, Film, Palette, Sparkles, Mail, Phone, Instagram, MessageCircle, ArrowRight } from "lucide-react";
  ...
  head: () => ({
    meta: [
      { title: "ZOR Visuals — Crafting Timeless Visual Stories" },
      {
        name: "description",
        content:
          "ZOR Visuals is a luxury photography, videography, and creative direction studio crafting timeless visual stories for premium brands.",
      },
      { property: "og:title", content: "ZOR Visuals — Crafting Timeless Visual Stories" },
      {
        property: "og:description",
        content: "Luxury photography, videography & creative direction.",
      },
    ],
  }),
});
  ...
  return (
    <main className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-24 pb-16 text-center">
        ...
        <img
          src={logo}
          alt="ZOR Visuals emblem"
          width={1024}
          height={1024}
          className="w-44 md:w-56 h-auto animate-fade-in"
        />
        <h1 className="mt-8 font-serif text-5xl md:text-7xl leading-[1.05] max-w-3xl animate-fade-up delay-100">
          Crafting <em className="gradient-gold-text not-italic">Timeless</em> Visual Stories
        </h1>
        <div className="mt-8 gold-divider animate-fade-up delay-200" />
        <p className="mt-6 text-xs md:text-sm tracking-luxury text-muted-foreground animate-fade-up delay-200">
      ...
      <section id="about" className="py-32 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-xs tracking-luxury text-gold mb-6">About</p>
          <h2 className="text-4xl md:text-5xl leading-tight">
            A studio devoted to the quiet beauty of well-told stories.
          </h2>
          <div className="mt-10 gold-divider" />
          <p className="mt-10 text-base md:text-lg leading-relaxed text-muted-foreground font-light">
      ...
      <section id="works" className="py-32 px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24 animate-fade-up">
            <p className="text-xs tracking-luxury text-gold mb-6 uppercase">Our Works</p>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif">Real stories. Real visuals.</h2>
            <div className="mt-8 gold-divider mx-auto" />
          </div>
          ...
          <div className="mb-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {instagramPosts.map((url, index) => (
                <div 
                  key={url} 
                  className="instagram-embed-container bg-black/40 rounded-sm overflow-hidden animate-fade-up border border-border/40 hover:border-gold/50 hover:shadow-[0_0_30px_rgba(212,175,55,0.15)] transition-all duration-500 group"
          ...
          <div className="animate-fade-up delay-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-border/40 border border-border/40 hover:shadow-[0_0_40px_rgba(212,175,55,0.1)] transition-shadow duration-700">
              {driveFiles.map((file) => (
                <div key={file.id} className="group relative bg-background aspect-video overflow-hidden">
                  <iframe
      ...
      <section id="services" className="py-32 px-6 bg-secondary/40">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            <p className="text-xs tracking-luxury text-gold mb-6">Services</p>
            <h2 className="text-4xl md:text-5xl">What we create</h2>
            <div className="mt-8 gold-divider" />
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-px bg-border/60">
            {services.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="group bg-background p-10 text-center transition-colors duration-500 hover:bg-card">
      ...
      <section id="founder" className="py-32 px-6 bg-secondary/40">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-xs tracking-luxury text-gold mb-6">Founder</p>
          <h2 className="text-4xl md:text-5xl leading-tight">
            Hi, I'm <em className="gradient-gold-text not-italic">Dhanuroop</em>
          </h2>
          <div className="mt-8 gold-divider" />
          <p className="mt-8 font-serif italic text-xl md:text-2xl leading-relaxed text-foreground">
          ...
          <p className="mt-8 text-xs tracking-luxury text-muted-foreground">
      ...
      <section id="contact" className="py-32 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-xs tracking-luxury text-gold mb-6">Contact</p>
          <h2 className="text-4xl md:text-6xl">Let's work together.</h2>
          <div className="mt-8 gold-divider" />
          ...
          <div className="mt-14 grid sm:grid-cols-3 gap-8 text-sm">
            <a href="mailto:hello@zorvisuals.com" className="group flex flex-col items-center gap-3 hover:text-gold transition-colors">
              <Mail className="w-5 h-5 text-gold" strokeWidth={1.25} />
              <span className="tracking-luxury text-xs text-muted-foreground group-hover:text-gold transition-colors">Email</span>
              <span>hello@zorvisuals.com</span>
            </a>
          ...
          <div className="mt-16 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="mailto:hello@zorvisuals.com"
              className="inline-flex items-center gap-3 px-10 py-4 bg-gold text-primary-foreground text-xs tracking-luxury hover:bg-[var(--gold-deep)] transition-colors duration-500"
